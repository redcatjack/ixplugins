...
ENT.PrintName = "Thin Double Door - DOWN"
...
function ENT:Initialize()
    self:SetModel("models/props/redcat/cmbdoors/cmb_door_double_thin.mdl")  -- Set your desired model
...
-- Register the entity
scripted_ents.Register(ENT, "double_thin_door_down")
