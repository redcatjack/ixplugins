...
ENT.PrintName = "Double Door - DOWN"
...
function ENT:Initialize()
    self:SetModel("models/props/redcat/cmbdoors/cmb_door_double.mdl")  -- Set your desired model
...
-- Register the entity
scripted_ents.Register(ENT, "double_door_down")
